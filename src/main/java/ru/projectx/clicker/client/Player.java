...
public class Player {
    ...
    public static void setMoney(int money) { Player.money = money; }

    public static void addKills() { Player.kills++; }

    public static void addLevel() { Player.level ++; }

    public static void addMoney(int money) { Player.money += money; }

    public static void setDamage(int damage) { Player.damage = damage; }

    public static void addDamage(int damage) { Player.damage += damage; }
